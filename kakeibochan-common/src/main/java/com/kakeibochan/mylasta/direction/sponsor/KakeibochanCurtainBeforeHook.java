 ...
 * @author jflute
 */
public class KakeibochanCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = KakeibochanUserTimeZoneProcessProvider.centralTimeZone;
