 ...
 * @author jflute
 */
public class KakeibochanSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public KakeibochanSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
