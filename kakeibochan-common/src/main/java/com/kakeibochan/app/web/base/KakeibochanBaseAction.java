...
import com.kakeibochan.app.logic.context.AccessContextLogic;
 ...
 * @author jflute
 */
public abstract class KakeibochanBaseAction extends TypicalAction {
    ...
    //                                                                           =========
    @Override
    protected abstract OptionalThing<? extends KakeibochanUserBean> getUserBean(); // to be more concrete
