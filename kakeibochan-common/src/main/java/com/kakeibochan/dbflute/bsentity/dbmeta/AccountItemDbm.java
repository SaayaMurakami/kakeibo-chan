...
/**
 * The DB meta of ACCOUNT_ITEM. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class AccountItemDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final AccountItemDbm _instance = new AccountItemDbm();
    private AccountItemDbm() {}
    public static AccountItemDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((AccountItem)et).getDelFlg(), (et, vl) -> {
            ...
            if (cls != null) {
                ((AccountItem)et).setDelFlgAsFlg(cls);
            } else {
                ((AccountItem)et).mynativeMappingDelFlg((String)vl);
            }
        }, "delFlg");
        setupEpg(_epgMap, et -> ((AccountItem)et).getRegisterDatetime(), (et, vl) -> ((AccountItem)et).setRegisterDatetime(ctldt(vl)), "registerDatetime");
        setupEpg(_epgMap, et -> ((AccountItem)et).getRegisterUser(), (et, vl) -> ((AccountItem)et).setRegisterUser((String)vl), "registerUser");
        setupEpg(_epgMap, et -> ((AccountItem)et).getUpdateDatetime(), (et, vl) -> ((AccountItem)et).setUpdateDatetime(ctldt(vl)), "updateDatetime");
        setupEpg(_epgMap, et -> ((AccountItem)et).getUpdateUser(), (et, vl) -> ((AccountItem)et).setUpdateUser((String)vl), "updateUser");
        setupEpg(_epgMap, et -> ((AccountItem)et).getVersionNo(), (et, vl) -> ((AccountItem)et).setVersionNo(ctl(vl)), "versionNo");
    }
    ...
    protected void xsetupEfpg() {
        setupEfpg(_efpgMap, et -> ((AccountItem)et).getMember(), (et, vl) -> ((AccountItem)et).setMember((OptionalEntity<Member>)vl), "member");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "ACCOUNT_ITEM";
    protected final String _tableDispName = "ACCOUNT_ITEM";
    protected final String _tablePropertyName = "accountItem";
    protected final TableSqlName _tableSqlName = new TableSqlName("ACCOUNT_ITEM", _tableDbName);
    { _tableSqlName.xacceptFilter(DBFluteConfig.getInstance().getTableSqlNameFilter()); }
    public String getTableDbName() { return _tableDbName; }
    public String getTableDispName() { return _tableDispName; }
    public String getTablePropertyName() { return _tablePropertyName; }
    public TableSqlName getTableSqlName() { return _tableSqlName; }
    protected final String _tableAlias = "勘定科目";
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnAccountTitle() { return _columnAccountTitle; }
    /**
    ...
    //                                       Primary Element
    //                                       ---------------
    protected UniqueInfo cpui() { return hpcpui(columnAccountItemId()); }
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("account_item_ibfk_1", "member", this, MemberDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "accountItemList", false);
    }
    ...
    public ReferrerInfo referrerRecordList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnAccountItemId(), RecordDbm.getInstance().columnAccountItemId());
        return cri("record_ibfk_1", "recordList", this, RecordDbm.getInstance(), mp, false, "accountItem");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.kakeibochan.dbflute.exentity.AccountItem"; }
    public String getConditionBeanTypeName() { return "com.kakeibochan.dbflute.cbean.AccountItemCB"; }
    public String getBehaviorTypeName() { return "com.kakeibochan.dbflute.exbhv.AccountItemBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<AccountItem> getEntityType() { return AccountItem.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public AccountItem newEntity() { return new AccountItem(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((AccountItem)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((AccountItem)et, mp); }
