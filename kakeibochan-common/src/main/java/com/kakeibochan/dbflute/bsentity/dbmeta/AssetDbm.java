...
public class AssetDbm extends AbstractDBMeta {
    ...
    public ReferrerInfo referrerRecordByWithdrawalAccountIdList() {
        ...
        return cri("record_ibfk_2", "recordByWithdrawalAccountIdList", this, RecordDbm.getInstance(), mp, false, "assetByWithdrawalAccountId");
    }
    /**
    ...
    public ReferrerInfo referrerRecordByDepositAccountIdList() {
        ...
        return cri("record_ibfk_3", "recordByDepositAccountIdList", this, RecordDbm.getInstance(), mp, false, "assetByDepositAccountId");
    }
