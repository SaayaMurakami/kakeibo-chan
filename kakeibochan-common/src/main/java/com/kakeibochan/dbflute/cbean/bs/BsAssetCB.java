...
/**
 * The base condition-bean of ASSET.
 * @author DBFlute(AutoGenerator)
 */
public class BsAssetCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected AssetCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public AssetCB acceptPK(Long assetId) {
        assertObjectNotNull("assetId", assetId);
        BsAssetCB cb = this;
        cb.query().setAssetId_Equal(assetId);
        return (AssetCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_AssetId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_AssetId_Desc();
        return this;
    }
     ...
     */
    public AssetCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public AssetCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected AssetCQ doGetConditionQuery() {
    ...
    protected AssetCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected AssetCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        AssetCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected AssetCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new AssetCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<AssetCB> unionCBLambda) {
        final AssetCB cb = new AssetCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final AssetCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<AssetCB> unionCBLambda) {
        final AssetCB cb = new AssetCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final AssetCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">assetBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">asset</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">asset</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<AssetCQ> {
        protected MemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<AssetCQ> qyCall
         ...
         */
        public SpecifiedColumn columnAssetId() { return doColumn("ASSET_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "ASSET"; }
        /**
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RecordCB, AssetCQ> derivedRecordByWithdrawalAccountId() {
         ...
         */
        public HpSDRFunction<AssetCB, AssetCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AssetCB> sq, AssetCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public AssetCB dreamCruiseCB() {
        AssetCB cb = new AssetCB();
        cb.xsetupForDreamCruise((AssetCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<AssetCB> columnQuery(final SpecifyQuery<AssetCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected AssetCB xcreateColumnQueryCB() {
        AssetCB cb = new AssetCB();
        cb.xsetupForColumnQuery((AssetCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<AssetCB> orCBLambda) {
        xorSQ((AssetCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AssetCB> andCBLambda) {
        xorSQAP((AssetCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return AssetCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return AssetCQ.class.getName(); }
