...
import com.kakeibochan.mylasta.direction.sponsor.BatchApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class BatchApiFailureHook extends KakeibochanApiFailureHook { // #change_it for handling API failure
