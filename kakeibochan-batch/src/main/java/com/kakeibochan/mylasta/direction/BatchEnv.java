...
import com.kakeibochan.mylasta.direction.KakeibochanConfig;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface BatchEnv extends KakeibochanConfig {

    /** The key of the configuration. e.g. batch-support@annie.example.com */
     ...
     * The value is, e.g. batch-support@annie.example.com <br>
     * comment: Mail Address for Batch Support
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends KakeibochanConfig.SimpleImpl implements BatchEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getMailAddressSupport() {
            return get(BatchEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getServerDomain() {
            return get(BatchEnv.SERVER_DOMAIN);
        }
    }
}
