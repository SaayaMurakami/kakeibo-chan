...
import com.kakeibochan.mylasta.action.BatchLabels;
 ...
 * @author FreeGen
 */
public class BatchMessages extends BatchLabels {
     ...
     * @return this. (NotNull)
     */
    public BatchMessages addErrorsSignupAccountAlreadyExists(String property) {
