...
import com.kakeibochan.app.web.base.login.BatchLoginAssist;
import com.kakeibochan.app.web.mypage.MypageAction;
import com.kakeibochan.mylasta.action.BatchMessages;
 ...
 * @author jflute
 */
public class SigninAction extends BatchBaseAction {
    ...
    private void moreValidate(SigninForm form, BatchMessages messages) {
