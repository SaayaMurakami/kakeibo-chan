...
import com.kakeibochan.mylasta.direction.sponsor.FrontApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class FrontApiFailureHook extends KakeibochanApiFailureHook { // #change_it for handling API failure
