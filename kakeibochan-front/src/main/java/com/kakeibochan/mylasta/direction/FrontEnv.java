 ...
 * @author FreeGen
 */
public interface FrontEnv extends KakeibochanConfig {

    /** The key of the configuration. e.g. front-support@annie.example.com */
     ...
     * The value is, e.g. front-support@annie.example.com <br>
     * comment: Mail Address for Front Support
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends KakeibochanConfig.SimpleImpl implements FrontEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getMailAddressSupport() {
            return get(FrontEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getServerDomain() {
            return get(FrontEnv.SERVER_DOMAIN);
        }
    }
}
