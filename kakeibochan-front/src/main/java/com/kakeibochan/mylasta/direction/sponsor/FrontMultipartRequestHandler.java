 ...
 */
public class FrontMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(FrontMultipartRequestHandler.class);
    ...
    protected void throwTooLongBoundarySizeException(String contentType, int boundarySize, int limitSize) {
        ...
        br.addElement(" in " + FrontMultipartRequestHandler.class.getSimpleName() + ".");
